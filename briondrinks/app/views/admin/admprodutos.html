    ...
    <div class="container table-responsive mb-5 conteudo-principal">
        <table class="table table-bordered table-hover shadow">
            ...
            <tr>
                ...
                <th scope="row"><img src="../img/batida.PNG" alt="Foto do Usuário" class="foto-tabela"></th>
                <td class="align-middle">Batida de frutas</td>
                <td class="align-middle colunasInvisiveis">As batidas de frutas são as receitas de drinks mais tradicionais e mais fáceis de servir no seu happy hour.</td>
                <td class="align-middle colunasInvisiveis">14,00</td>
                <td class="align-middle colunasInvisiveis">Batido</td>
            ...
            <tr>
                <th scope="row"><img src="../img/gin.PNG" alt="Foto do Usuário" class="foto-tabela"></th>
                <td class="align-middle">Gin Tônica</td>
                <td class="align-middle colunasInvisiveis">O clássico drink feito com Gin é super fácil de preparar (além de saboroso e refrescante!)</td>
                <td class="align-middle colunasInvisiveis">19,00</td>
                <td class="align-middle colunasInvisiveis">Montado</td>
                <td class="align-middle">
                    <div class="btn-group d-flex justify-content-center" role="group">
                        <button type="button" class="btn btn-success border" data-toggle="modal" data-target="#modalAdicionar"><i class="fa fa-pencil" aria-hidden="true"></i></button>
                        <button type="button" class="btn btn-danger border" data-toggle="modal" data-target="#modalExcluir"><i class="fa fa-trash" aria-hidden="true"></i></button>
            ...
            <tr>
                <th scope="row"><img src="../img/ginmule.PNG" alt="Foto do Usuário" class="foto-tabela"></th>
                <td class="align-middle">Gin Mule</td>
                <td class="align-middle colunasInvisiveis">O Gin Mule é uma bebida que virou tendência e que, por isso, você precisa ter no seu happy hour!.</td>
                <td class="align-middle colunasInvisiveis">20,00</td>
                <td class="align-middle colunasInvisiveis">Montado</td>
                <td class="align-middle">
                    <div class="btn-group d-flex justify-content-center" role="group">
                        <button type="button" class="btn btn-success border" data-toggle="modal" data-target="#modalAdicionar"><i class="fa fa-pencil" aria-hidden="true"></i></button>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="campo1" placeholder="Nome" required>
                    </div>
                    <div class="form-group">
                            <label for="campo1">Descrição</label>
                            <input type="text" class="form-control" id="campo2" placeholder="Descrição" required>
                        </div>
                    <div class="form-row">
                        <div class="form-group col-md-6"> 
                            <label for="campo4">Categoria</label> 
                            <input type="text" class="form-control" id="campo4" placeholder="Categoria" required> 
                        </div>
                        <div class="form-group col-md-6">
                            <label for="campo3">Preço</label>
                            <input type="text" class="form-control" id="campo3" placeholder="Preço" required>
                        </div>
